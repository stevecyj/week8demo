<script>
import { apiGetSingleProduct } from '@/libs/api';
    ...
    <div class="container">
        ...
        <div class="row justify-content-between mt-4 mb-7">
            <div class="col-md-7">
                ...
                <div class="my-4">
                    <img v-for="image in product.imagesUrl" :key="image" :src="image"
                        :alt="product.title" class="img-fluid mt-4">
                </div>
            ...
            <div class="col-md-4">
                <div class="input-group mb-3 border mt-3">
                    <div class="input-group-prepend">
                        <button id="button-addon1"
                            class="btn btn-outline-dark rounded-0 border-0 py-3" type="button">
                            <i class="fas fa-minus"></i>
                        </button>
                    </div>
                ...
                <a href="./checkout.html" class="btn btn-dark btn-block rounded-0 py-3">Lorem
                    ipsum</a>
            </div>
        </div>
    </div>
